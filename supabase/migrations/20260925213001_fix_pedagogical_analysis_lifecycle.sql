...
begin
  ...
  -- Any evidence edit invalidates previously active recommendations for
  -- this student/assessment. A new analysis must justify them again.
...
begin
  ...
  -- A newly completed analysis supersedes active recommendations created by
  -- earlier versions of the evidence for the same assessment.
  update public.pedagogical_recommendations
  set dismissed_at = now()
  where assessment_id=p_assessment_id
    and student_id=p_student_id
