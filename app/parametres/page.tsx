  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-ink-soft">Cette section sera développée dans une prochaine version.</p>
      </div>
      ...
      <section className="rounded-[var(--radius-lg)] border border-border bg-surface p-5">
        ...
        <div className="mt-4 space-y-3 text-sm">
          <div className="flex items-center justify-between border-b border-border pb-3">
            ...
            <span className="font-medium text-ink">{currentTeacher}</span>
          </div>
          <div className="flex items-center justify-between border-b border-border pb-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-medium text-ink">Lycée démonstration FOCUS</span>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-[var(--radius-lg)] border border-dashed border-border-strong bg-paper p-5">
        ...
        <ul className="mt-3 space-y-1.5 text-sm text-ink-soft">
          <li>— Gestion des comptes et des accès</li>
